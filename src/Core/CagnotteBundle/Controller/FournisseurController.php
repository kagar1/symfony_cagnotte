...
use Core\CagnotteBundle\Entity\Fournisseur;
...
class FournisseurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fournisseurs = $em->getRepository('CoreCagnotteBundle:Fournisseur')->findAll();

        return $this->render('CoreCagnotteBundle:fournisseur:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Core\CagnotteBundle\Form\FournisseurType', $fournisseur);
        ...
        return $this->render('CoreCagnotteBundle:fournisseur:new.html.twig', array(
    ...
    public function showAction(Fournisseur $fournisseur)
    {
        ...
        return $this->render('CoreCagnotteBundle:fournisseur:show.html.twig', array(
            'fournisseur' => $fournisseur,
    ...
    {
        $deleteForm = $this->createDeleteForm($fournisseur);
        $editForm = $this->createForm('Core\CagnotteBundle\Form\FournisseurType', $fournisseur);
        ...
        return $this->render('CoreCagnotteBundle:fournisseur:edit.html.twig', array(
            'fournisseur' => $fournisseur,
