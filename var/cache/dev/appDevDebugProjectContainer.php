...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_d22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26c' => 'get1D22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26cService',
            '2_d22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26c' => 'get2D22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26cService',
        ...
        $this->privates = array(
            '1_d22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26c' => true,
            '2_d22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26c' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_d22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26c']) ? $this->services['1_d22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26c'] : $this->get1D22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26cService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_d22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26c']) ? $this->services['2_d22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26c'] : $this->get2D22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26cService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_879be01105921bb47b146149e6e11356bd00eb8805ca371e655fe2ee692ae1bd');
    ...
    /**
     * Gets the private '1_d22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26c' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1D22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26cService()
    {
        return $this->services['1_d22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26c'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_d22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26c' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2D22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26cService()
    {
        return $this->services['2_d22db97afedd9beae6d44a95641ae863960e6b6f970e3ac919cd30730b48c26c'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FFHeNLCbm0', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dip6GmFvHu', 0, 'Aj7w+m0Pc1RSRlON-9uJRM', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WqPVZdhZd+', 0, 'Aj7w+m0Pc1RSRlON-9uJRM', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2U4IC8vSDv', 0, 'Aj7w+m0Pc1RSRlON-9uJRM', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59ce3b8d913137.81661939');
    }
